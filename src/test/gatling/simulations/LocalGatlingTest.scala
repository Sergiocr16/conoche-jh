...
class LocalGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Local entity")
        ...
        .repeat(2) {
            ...
            .post("/api/locals")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "longitud":1, "banner":null, "bannerUrl":"SAMPLE_TEXT", "latitud":1, "descripcion":"SAMPLE_TEXT", "provincia":"SAN_JOSE", "rating":1}""")).asJSON
            .check(status.is(201))
