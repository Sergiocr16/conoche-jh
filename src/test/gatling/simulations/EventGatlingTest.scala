...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "details":"hola", "price":3000, "localId":4, "banner":null, "bannerUrl":"SAMPLE_TEXT", "initialTime":"2020-01-01T00:00:00.000Z", "finalTime":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
