...
public class MessageResourceIntTest {
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getCreationTime()).isEqualTo(DEFAULT_CREATION_TIME);
    }
    ...
    public void createMessageWithExistingId() throws Exception {
        ...
        MessageDTO existingMessageDTO = messageMapper.messageToMessageDTO(existingMessage);

        // An entity with an existing ID cannot be created, so this API call must fail
        restMessageMockMvc.perform(post("/api/messages")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingMessageDTO)))
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getCreationTime()).isEqualTo(UPDATED_CREATION_TIME);
    }
