...
(function () {
    ...
    angular.module('conocheApp').factory('ImageUtil', ImageUtil);

    function ImageUtil() {
        var _marked = [forEachPixel, forEachAlphaPixel].map(regeneratorRuntime.mark);
        ...
        function forEachPixel(context, spacing) {
            var width, height, pixels, y, x, i, RGBA;
